...
\usepackage{beamerthemesplit} % Activate split theme
\usecolortheme{seahorse} % Color theme
\usefonttheme{professionalfonts} % Use professional fonts
\setbeamertemplate{navigation symbols}{} % Remove navigation symbols
\setbeamertemplate{footline}[frame number] % Display frame number in footer
\useoutertheme{miniframes} % Use miniframes outer theme
