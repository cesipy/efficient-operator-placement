...
Das Operatorplatzierungproblem  kann als Zuordnungsproblem zwischen den genannten Modellen formuliert werden. 
...
Zwei Operatoren $i,j \in G_{svs}$, wobei $i$ auf $u \in G_{res}$ und $j$ auf $v \in G_{res}$ platziert ist, werden als \textit{kolloziert} bezeichnet, 
...
Deshalb wollen wir uns auf Heuristiken fokusieren, die zru Laufzeit angepasst werden können.
