...
\captionof{figure}{Sequentielle, replizierte und Diamant-Topologie}
\label{topologies}
\end{minipage}
\hspace{10pt}
...
Für das Experiment werden die Auflösungszeit (rt) und die Leistungseinbuße (pd) betrachtet \cite{efficient-operator-placement}.
...
Pf wird definiert als $pd_i = \frac{F_i - F_{ODP}}{1 - F_{ODP}}$ \cite{efficient-operator-placement}, 
...
Die Berechnung der Optimalösung weist eine effizient Laufzeit für Diamand basierte auf. 
Diese Berechnung ist in unter einer Sekunde verfügbar. 
