...
Die lokale Suche iteriert über die Konfigurationen, die aus der Greedy First Fit Heuristik resultieren, um eine bessere Lösung zu finden. Der Algorithmus dafür wird im Algorithmus 1 \ref{local-search-algo} gezeigt. 
...
Um dem entgegenzuwirken, wird die Heurisik zur Tabu Search erweitert. 
